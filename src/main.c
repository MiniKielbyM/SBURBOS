...
uint8_t font[95][8] = {
    {0, 0, 0, 0, 0, 0, 0, 0},                         // SP
    {0, 0x40, 0x40, 0x40, 0x40, 0, 0x40, 0},          // !
    {0, 0x28, 0x28, 0x14, 0, 0, 0, 0},                // "
    {0x24, 0x24, 0xFF, 0x24, 0x24, 0xFF, 0x24, 0x24}, // #
    {0x14, 0x3E, 0x54, 0x54, 0x3E, 0x15, 0x15, 0x3E}, // $
    {0x20, 0x50, 0x22, 0xC, 0x30, 0x44, 0xA, 0x4},    // %
    {0x10, 0x28, 0x10, 0x34, 0x58, 0x48, 0x34, 0},     // &
    {0x18,0x18, 0x8, 0, 0, 0, 0, 0}, // '
    {0x8, 0x10, 0x20, 0x20, 0x20, 0x20, 0x10, 0x8}, // (
    {}, // )
    {}, // *
    {}, // +
    {}, // ,
...
void kmain(void)
{
    ...
    serial_write("[SBURBOS] drew test pixels, halting\n");
